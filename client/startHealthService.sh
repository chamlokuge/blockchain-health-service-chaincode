...
docker exec -e “CORE_PEER_LOCALMSPID=Org1MSP” -e “CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp” cli peer chaincode invoke -o orderer.example.com:7050 -C mychannel -n mycc -c '{"function":"submitRecord","Args":["patient1","01/12/1987","0785245256","01/01/2020","1010","Medical check up","Physician1","Tuberculosis","RBC count","Test Result 1","Prescribed action 1","Prescribed medication 1","Document1 of patient1"]}'
